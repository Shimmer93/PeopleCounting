...
from models.baselines.HigherHRNet_config import default_config
...
def HigherHRNet(pretrained=False):
    model = PoseHigherResolutionNet(default_config())
    if pretrained:
        model.init_weights(pretrained=default_config().MODEL.PRETRAINED)
