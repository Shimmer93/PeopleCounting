...
from models.baselines.HRFormer_config import MODEL_CONFIGS
...
class HRFormer(nn.Module):
    def __init__(self, arch):
        ...
        self.backbone = HighResolutionTransformer(MODEL_CONFIGS[arch])
        self.head = nn.Sequential(
            nn.Conv2d(78, 1, kernel_size=3, padding=1),
        )
...
if __name__ == "__main__":
    model = HRFormer("hrt_base_win13").cuda()
    model.eval()
